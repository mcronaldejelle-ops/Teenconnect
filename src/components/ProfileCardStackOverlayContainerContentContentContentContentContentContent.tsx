...
interface ProfileCardStackOverlayContainerContentContentContentContentContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContentContentContentContentContent: React.FC<ProfileCardStackOverlayContainerContentContentContentContentContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
