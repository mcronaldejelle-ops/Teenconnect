...
interface ProfileCardStackActionsContainerContentContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContentContent: React.FC<ProfileCardStackActionsContainerContentContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
