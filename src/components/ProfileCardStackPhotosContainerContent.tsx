...
interface ProfileCardStackPhotosContainerContentProps {
  photos: string[];
  name: string;
}

export const ProfileCardStackPhotosContainerContent: React.FC<ProfileCardStackPhotosContainerContentProps> = ({
  photos,
  name,
}) => {
