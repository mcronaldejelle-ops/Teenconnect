...
interface ProfileCardStackOverlayContainerContentContentContentContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContentContentContentContent: React.FC<ProfileCardStackOverlayContainerContentContentContentContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
