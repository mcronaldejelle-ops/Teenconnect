...
interface ProfileCardStackInfoContainerContentContentContentContentContentContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContentContentContentContentContentContent: React.FC<ProfileCardStackInfoContainerContentContentContentContentContentContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
