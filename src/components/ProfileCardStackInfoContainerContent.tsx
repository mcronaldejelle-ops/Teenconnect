...
interface ProfileCardStackInfoContainerContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContent: React.FC<ProfileCardStackInfoContainerContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
