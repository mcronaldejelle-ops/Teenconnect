...
interface ProfileCardStackInfoContainerContentContentContentContentContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContentContentContentContentContent: React.FC<ProfileCardStackInfoContainerContentContentContentContentContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
