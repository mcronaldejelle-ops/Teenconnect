...
interface ProfileCardStackOverlayContainerContentContentContentContentContentContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContentContentContentContentContentContent: React.FC<ProfileCardStackOverlayContainerContentContentContentContentContentContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
