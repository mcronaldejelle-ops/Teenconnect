...
interface ProfileCardStackOverlayContainerContentContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContentContent: React.FC<ProfileCardStackOverlayContainerContentContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
