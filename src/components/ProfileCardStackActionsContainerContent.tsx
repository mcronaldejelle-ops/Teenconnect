...
interface ProfileCardStackActionsContainerContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContent: React.FC<ProfileCardStackActionsContainerContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
