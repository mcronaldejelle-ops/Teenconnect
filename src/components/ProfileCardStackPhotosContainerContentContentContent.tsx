...
interface ProfileCardStackPhotosContainerContentContentContentProps {
  photos: string[];
  name: string;
}

export const ProfileCardStackPhotosContainerContentContentContent: React.FC<ProfileCardStackPhotosContainerContentContentContentProps> = ({
  photos,
  name,
}) => {
