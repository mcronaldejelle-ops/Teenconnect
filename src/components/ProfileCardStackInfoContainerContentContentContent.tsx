...
interface ProfileCardStackInfoContainerContentContentContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContentContentContent: React.FC<ProfileCardStackInfoContainerContentContentContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
