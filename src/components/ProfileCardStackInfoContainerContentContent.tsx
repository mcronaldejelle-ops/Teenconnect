...
interface ProfileCardStackInfoContainerContentContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContentContent: React.FC<ProfileCardStackInfoContainerContentContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
