...
interface ProfileCardStackActionsContainerContentContentContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContentContentContent: React.FC<ProfileCardStackActionsContainerContentContentContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
