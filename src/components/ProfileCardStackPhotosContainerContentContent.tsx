...
interface ProfileCardStackPhotosContainerContentContentProps {
  photos: string[];
  name: string;
}

export const ProfileCardStackPhotosContainerContentContent: React.FC<ProfileCardStackPhotosContainerContentContentProps> = ({
  photos,
  name,
}) => {
