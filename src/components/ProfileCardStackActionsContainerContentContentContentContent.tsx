...
interface ProfileCardStackActionsContainerContentContentContentContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContentContentContentContent: React.FC<ProfileCardStackActionsContainerContentContentContentContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
