...
interface ProfileCardStackInfoContainerContentContentContentContentProps {
  name: string;
  age: number;
  bio: string;
  onShowInfo?: () => void;
...
export const ProfileCardStackInfoContainerContentContentContentContent: React.FC<ProfileCardStackInfoContainerContentContentContentContentProps> = ({
  name,
  age,
  bio,
  onShowInfo,
