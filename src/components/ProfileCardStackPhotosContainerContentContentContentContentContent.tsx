...
interface ProfileCardStackPhotosContainerContentContentContentContentContentProps {
  photos: string[];
  name: string;
}

export const ProfileCardStackPhotosContainerContentContentContentContentContent: React.FC<ProfileCardStackPhotosContainerContentContentContentContentContentProps> = ({
  photos,
  name,
}) => {
