...
interface ProfileCardStackOverlayContainerContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContent: React.FC<ProfileCardStackOverlayContainerContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
