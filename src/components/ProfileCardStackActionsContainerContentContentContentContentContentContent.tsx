...
interface ProfileCardStackActionsContainerContentContentContentContentContentContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContentContentContentContentContentContent: React.FC<ProfileCardStackActionsContainerContentContentContentContentContentContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
