...
interface ProfileCardStackPhotosContainerContentContentContentContentContentContentProps {
  photos: string[];
  name: string;
}

export const ProfileCardStackPhotosContainerContentContentContentContentContentContent: React.FC<ProfileCardStackPhotosContainerContentContentContentContentContentContentProps> = ({
  photos,
  name,
}) => {
