...
interface ProfileCardStackActionsContainerContentContentContentContentContentProps {
  onLike: () => void;
  onPass: () => void;
  onSuperLike?: () => void;
  onBoost?: () => void;
...
export const ProfileCardStackActionsContainerContentContentContentContentContent: React.FC<ProfileCardStackActionsContainerContentContentContentContentContentProps> = ({
  onLike,
  onPass,
  onSuperLike,
  onBoost,
