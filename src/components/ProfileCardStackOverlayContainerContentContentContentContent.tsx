...
interface ProfileCardStackOverlayContainerContentContentContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContentContentContent: React.FC<ProfileCardStackOverlayContainerContentContentContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
