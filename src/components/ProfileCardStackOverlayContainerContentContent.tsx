...
interface ProfileCardStackOverlayContainerContentContentProps {
  likeOpacity: any;
  nopeOpacity: any;
}

export const ProfileCardStackOverlayContainerContentContent: React.FC<ProfileCardStackOverlayContainerContentContentProps> = ({
  likeOpacity,
  nopeOpacity,
}) => {
  return (
